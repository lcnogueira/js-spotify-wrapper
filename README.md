...
[![Build Status](https://travis-ci.org/lcnogueira/js-spotify-wrapper.svg?branch=master)](https://travis-ci.org/lcnogueira/js-spotify-wrapper) [![Coverage Status](https://coveralls.io/repos/github/lcnogueira/js-spotify-wrapper/badge.svg?branch=master)](https://coveralls.io/github/lcnogueira/js-spotify-wrapper?branch=master)
...
```sh
$ npm install js-spotify-wrapper-lib
```
...
```js
const SpotifyWrapper = require('js-spotify-wrapper-lib').default;
